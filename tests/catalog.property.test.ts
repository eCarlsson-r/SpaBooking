...
import enCatalog from '../app/i18n/locales/en.json';
import idCatalog from '../app/i18n/locales/id.json';
...
describe('SpaBooking Translation Catalog Key Symmetry', () => {
...
describe('SpaBooking Missing Translation Key Fallback', () => {
